...
if (typeof md !== "string") {
throw new TypeError("Not a string, carry on.");
}
...
console.log(`%cDOMPurify ${version} delivering sanitized HTML.`, "color: #28a745;");
...
console.warn("%cDOMPurify not running, HTML out is not sanitized.", "color: #d9534f;");
